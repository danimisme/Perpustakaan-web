...
import { hideEditForm } from "../../redux/features/formEditSlice";
...
export default function EditBook() {
  ...
  const isShow = useAppSelector((state) => state.formEdit.isShow);
  const book = useAppSelector((state) => state.formEdit.book);
